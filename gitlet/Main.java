...
public class Main {
    ...
    /** Checks that there is not already a .gitlet directory within this directory. Returns boolean true if .gitlet is
    ...
    /** Takes in a string ARG word, will return whether or not it is a valid command. */
    ...
    /** Will do the work of actually saving our information from the repo. It returns the existing repo, assuming
     * that there is one. */
