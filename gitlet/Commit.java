...
public class Commit implements Serializable {
    /** commit is initialized with a message M, a HashMap
    ...
    /** This function hashes the present commit based off of the commit message, files, timestamp, and parents.
     * To return a hash. */
    ...
    /** Returns one to get the commit message of this specific commit. */
    public String getMessage() {
        return _message;
    }

    /** Returns one to make an initial commit easily.*/
    public static Commit initialCommit() {
        return new Commit("initial commit", null, null, false);
    }

    /** Returns one to get all of the files that belong to a particular commit. */
    public HashMap<String, String> getFiles() {
        return _files;
    }

    /** Returns one to get the timestamp of this particular commit.  */
    public String getTimestamp() {
        return _timestamp;
    }

    /** Returns you to get the ID of the first parent of this particular commit. */
    ...
    /** Returns you to get the whole parents set from this particular commit. */
    public String[] getParents() {
        return _parents;
    }

    /** Returns you to get the unviersal ID from the particular commit. */
